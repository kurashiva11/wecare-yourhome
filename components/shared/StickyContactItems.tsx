...
export default function StickyContactItems() {
    return (
        <div className="fixed right-0 top-1/3">
          ...
          <div className="h-1" />
          <span onClick={() => window.open('https://api.whatsapp.com/send?phone=8096243936', '_blank')}><Image src={normalizedPath("/whatsapp.svg")} alt="whatsapp" width={48} height={48} /></span>
        </div>
    );
}